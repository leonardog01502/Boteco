...
namespace AppBoteco
{
    ...
    {
        SqlConnection con = new SqlConnection("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=\"E:\\Programação\\2° Trimestre\\Emerson\\Aula 8\\Formulario boteco\\AppBoteco\\AppBoteco\\DbBoteco.mdf\";Integrated Security=True");
        public FrmVenda()
        {
            InitializeComponent();
            CarregaCbxProduto();
        ...
        private void btnFinalizarPedido_Click(object sender, EventArgs e)
        {
            ...
            foreach (DataGridViewRow dr in dgvPedido.Rows)
            {
                SqlCommand cmditens = new SqlCommand("InserirItensPedido", con);
        ...
        private void btnLocalizar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0 && venda == "Aberta")
                {
                    ...
                    if (linhasped > 0)
                    {
                        ...
                        btnEditarItem.Enabled = true;
                        btnExcluirItem.Enabled = true;
                        /*criando nosso DataGridView
                            Nesse DGV é o Cliente que coloca*/
                        dgvPedido.Columns.Add("ID", "ID");
                        dgvPedido.Columns.Add("Produto", "Produto");
                        dgvPedido.Columns.Add("Quantidade", "Quantidade");
                        dgvPedido.Columns.Add("Valor", "Valor");
                ...
                else
                {
                    ...
                    lvenda.Parameters.Add("@Id", SqlDbType.Int).Value = Convert.ToInt32(txtId.Text.Trim());
            ...
            {
                MessageBox.Show("Nenhum pedido ou venda foi localizado. Por Favor, verifique o ID correto.", "Erro", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            con.Close();
        }
        ...
        private void btnAtualizarPedido_Click(object sender, EventArgs e)
        {
            ...
            foreach (DataGridViewRow dr in dgvPedido.Rows)
            {
                SqlCommand itens = new SqlCommand("InserirItensPedido", con);
            ...
            con.Close();
            MessageBox.Show("Pedido atualizado com secesso !!", "Atualização do pedido", MessageBoxButtons.OK, MessageBoxIcon.Information);
            dgvPedido.Columns.Clear();
            dgvPedido.Rows.Clear();
            txtId.Text = "";
            txtTotal.Text = "";
        ...
        private void btnFinalizarVenda_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("UPADATE Venda SET situacao = @situacao WHERE Id = @Id", con);
            cmd.Parameters.AddWithValue("@Id", SqlDbType.Int).Value = Convert.ToInt32(txtId.Text.Trim());
            ...
            con.Close();
            MessageBox.Show("Venda realizada com sucesso !!", "Venda do pedido", MessageBoxButtons.OK, MessageBoxIcon.Information);
            dgvPedido.Columns.Clear();
            dgvPedido.Rows.Clear();
            txtId.Text = "";
            txtTotal.Text = "";
